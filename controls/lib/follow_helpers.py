...
ONE_BAR_PROFILE = FollowProfile(
  vEgoProfiles=(
    ...
    vEgoProfile(vEgo=CITY_SPEED, v_rel=[-0.07, 2.50], TR=[ONE_BAR_DISTANCE, 2.3]),
    vEgoProfile(vEgo=HIGHWAY_SPEED, v_rel=[-0.04, 2.50], TR=[ONE_BAR_DISTANCE, ONE_BAR_DISTANCE-0.15]),))
TWO_BAR_PROFILE = FollowProfile(
  vEgoProfiles=(
    vEgoProfile(vEgo=SNG_SPEED, v_rel=[0], TR=[SNG_DISTANCE]),
    vEgoProfile(vEgo=CITY_SPEED, v_rel=[-0.07, 3.0], TR=[TWO_BAR_DISTANCE, 2.1]),
    vEgoProfile(vEgo=HIGHWAY_SPEED, v_rel=[0.0, 3.0], TR=[TWO_BAR_DISTANCE, TWO_BAR_DISTANCE+0.0]),))
THREE_BAR_PROFILE = FollowProfile(
  vEgoProfiles=(
    vEgoProfile(vEgo=SNG_SPEED, v_rel=[0], TR=[SNG_DISTANCE]),
    vEgoProfile(vEgo=CITY_SPEED,  v_rel=[0.0, 4.0], TR=[THREE_BAR_DISTANCE, 2.1]),
    vEgoProfile(vEgo=HIGHWAY_SPEED, v_rel=[-0.04, 2.50], TR=[THREE_BAR_DISTANCE, THREE_BAR_DISTANCE-0.18]),))
